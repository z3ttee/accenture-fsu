...
// See: constructor injection. In these cases, the @Injectable decorator is required
// 
// NOTE: A service must always be declared as a provider in the Angular module that
